...
contract TokenVestingRetail is Ownable {
    ...
    constructor (address beneficiary, uint256 start) public {
        require(beneficiary != address(0), "TokenVestingRetail: beneficiary is the zero address");
        ...
        require(start.add(_duration) > block.timestamp, "TokenVestingRetail: final time is before current time");
    }
    ...
    function release(IERC20 token) public {
        ...
        require(unreleased > 0, "TokenVestingRetail: no tokens are due");
